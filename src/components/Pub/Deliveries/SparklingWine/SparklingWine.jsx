...
class SparklingWineDel extends Component {
  ...
  componentDidMount() {
    ...
    let requisitionsRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Sparkling Wine/Requisitions/" + currDate);
    requisitionsRef.on("value", snapshot => {
      ...
      if (requisitioningqty !== null) {
        ...
        let nullRequisitionsRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/Sparkling Wine/Requisitions/00-00-00");
...
export default SparklingWineDel;
