...
import { Items, PAR, Requisitions, UpdateRequisitions } from "./RedWineParts";
import Submit from "../submit";
import "../../../styles.css";

class RedWineReq extends Component {
  state = {
    items: [],
    par: [],
    requisitions: [],
  ...
  cancelCourse = () => {
    document.getElementById("rwreq").reset();
  };
  calcTime = offset => {
    let d = new Date();
