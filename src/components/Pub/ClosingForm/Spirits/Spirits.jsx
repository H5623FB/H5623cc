...
class Spirits extends Component {
  ...
  componentDidMount() {
    ...
    let openRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Spirits/Close/" + prevDate);
    ...
    openRef.on("value", snapshot => {
      ...
      if (openingqty !== null) {
        ...
        let nullOpeningRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/Spirits/Close/00-00-00");
    ...
    let saleRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Spirits/Sold/" + currDate);
    saleRef.on("value", snapshot => {
      ...
      if (saleqty !== null) {
        ...
        let nullSaleRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/Spirits/Sold/00-00-00");
    ...
    let closingRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Spirits/Close/" + currDate);
    ...
    let commentsRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Spirits/Comments");
    ...
    let deliveredRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Spirits/Delivered/" + currDate);
    deliveredRef.on("value", snapshot => {
      ...
      if (deliveredqty !== null) {
        ...
        let nulldeliveredRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/Spirits/Delivered/00-00-00");
    ...
    let differenceRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Spirits/Difference/" + currDate);
    differenceRef.on("value", snapshot => {
      ...
      if (differenceqty !== null) {
        ...
        let nullDifferenceRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/Spirits/Difference/00-00-00");
    ...
    let parRef = fire.database().ref("ILEC/Pub/ClosingForm/Spirits/PAR");
    ...
    let transfersRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Spirits/Transfers/" + currDate);
    transfersRef.on("value", snapshot => {
      ...
      if (transfersqty !== null) {
        ...
        let nullTransfersRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/Spirits/Transfers/00-00-00");
