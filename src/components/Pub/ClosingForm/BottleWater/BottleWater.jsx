...
class BottleWater extends Component {
  state = {
    items: [],
    opening: [],
    sale: [],
  ...
  componentDidMount() {
    ...
    let openRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/BottleWater/Close/" + prevDate);
    ...
    openRef.on("value", snapshot => {
      ...
      if (openingqty !== null) {
        ...
        let nullOpeningRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/BottleWater/Close/00-00-00");
    ...
    let saleRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/BottleWater/Sold/" + currDate);
    saleRef.on("value", snapshot => {
      ...
      if (saleqty !== null) {
        ...
        let nullSaleRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/BottleWater/Sold/00-00-00");
    ...
    let closingRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/BottleWater/Close/" + currDate);
    ...
    let commentsRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/BottleWater/Comments");
    ...
    let deliveredRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/BottleWater/Delivered/" + currDate);
    deliveredRef.on("value", snapshot => {
      ...
      if (deliveredqty !== null) {
        ...
        let nulldeliveredRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/BottleWater/Delivered/00-00-00");
    ...
    let differenceRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/BottleWater/Difference/" + currDate);
    differenceRef.on("value", snapshot => {
      ...
      if (differenceqty !== null) {
        ...
        let nullDifferenceRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/BottleWater/Difference/00-00-00");
    ...
    //   .database()
    //   .ref("ILEC/Pub/ClosingForm/BottleWater/Transfers/" + currDate);
    ...
    //       .database()
    //       .ref("ILEC/Pub/ClosingForm/BottleWater/Transfers/00-00-00");
    ...
    let wastageRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/BottleWater/Wastage/" + currDate);
    wastageRef.on("value", snapshot => {
      ...
      if (wastageqty !== null) {
        ...
        let nullWastageRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/BottleWater/Wastage/00-00-00");
