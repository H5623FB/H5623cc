...
class WhiteWine extends Component {
  state = {
    items: [],
    opening: [],
    sale: [],
  ...
  componentWillMount() {
    ...
    let openRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/White Wine/Close/" + prevDate);
    ...
    openRef.on("value", snapshot => {
      ...
      if (openingqty !== null) {
        ...
        let nullOpeningRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/White Wine/Close/00-00-00");
    ...
    let saleRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/White Wine/Sold/" + currDate);
    saleRef.on("value", snapshot => {
      ...
      if (saleqty !== null) {
        ...
        let nullSaleRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/White Wine/Sold/00-00-00");
    ...
    let closingRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/White Wine/Close/" + currDate);
    ...
    let commentsRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/White Wine/Comments");
    ...
    deliveredRef.on("value", snapshot => {
      ...
      if (deliveredqty !== null) {
        ...
        let nulldeliveredRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/White Wine/Delivered/00-00-00");
    ...
    let differenceRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/White Wine/Difference/" + currDate);
    differenceRef.on("value", snapshot => {
      ...
      if (differenceqty !== null) {
        ...
        let nullDifferenceRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/White Wine/Difference/00-00-00");
    ...
    let transfersRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/White Wine/Transfers/" + currDate);
    transfersRef.on("value", snapshot => {
      ...
      if (transfersqty !== null) {
        ...
        let nullTransfersRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/White Wine/Transfers/00-00-00");
    ...
    let wastageRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/White Wine/Wastage/" + currDate);
    wastageRef.on("value", snapshot => {
      ...
      if (wastageqty !== null) {
        ...
        let nullWastageRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/White Wine/Wastage/00-00-00");
  ...
  cancelCourse = () => {
    document.getElementById("wwine").reset();
  };
  calcTime = offset => {
    let d = new Date();
