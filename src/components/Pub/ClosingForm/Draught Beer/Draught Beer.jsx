...
class DraughtBeer extends Component {
  ...
  componentDidMount() {
    ...
    let openRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Draught Beer & Cider/Close/" + prevDate);
    ...
    openRef.on("value", snapshot => {
      ...
      if (openingqty !== null) {
        ...
        let nullOpeningRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/Draught Beer & Cider/Close/00-00-00");
    ...
    let saleRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Draught Beer & Cider/Sold/" + currDate);
    saleRef.on("value", snapshot => {
      ...
      if (saleqty !== null) {
        ...
        let nullSaleRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/Draught Beer & Cider/Sold/00-00-00");
    ...
    let closingRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Draught Beer & Cider/Close/" + currDate);
    ...
    let deliveredRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Draught Beer & Cider/Delivered/" + currDate);
    deliveredRef.on("value", snapshot => {
      ...
      if (deliveredqty !== null) {
        ...
        let nulldeliveredRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/Draught Beer & Cider/Delivered/00-00-00");
    ...
    let differenceRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Draught Beer & Cider/Difference/" + currDate);
    differenceRef.on("value", snapshot => {
      ...
      if (differenceqty !== null) {
        ...
        let nullDifferenceRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/Draught Beer & Cider/Difference/00-00-00");
    ...
    //   .database()
    //   .ref("ILEC/Pub/ClosingForm/Draught Beer & Cider/Transfers/" + currDate);
    ...
    //       .database()
    //       .ref("ILEC/Pub/ClosingForm/Draught Beer & Cider/Transfers/00-00-00");
    ...
    let wastageRef = fire
      .database()
      .ref("ILEC/Pub/ClosingForm/Draught Beer & Cider/Wastage/" + currDate);
    wastageRef.on("value", snapshot => {
      ...
      if (wastageqty !== null) {
        ...
        let nullWastageRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/Draught Beer & Cider/Wastage/00-00-00");
