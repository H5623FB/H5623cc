...
import { Items, Wastage, UpdateWastage } from "./softDrinkParts";
import Submit from "../submit";
import "../../../styles.css";

class SoftWastage extends Component {
  state = {
    items: [],
    wastage: [],
    rid: [],
  ...
  cancelCourse = () => {
    document.getElementById("sdwast").reset();
  };
  calcTime = offset => {
    let d = new Date();
