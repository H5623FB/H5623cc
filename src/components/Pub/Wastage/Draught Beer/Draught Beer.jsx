...
import { Items, Wastage, UpdateWastage } from "./Draught BeerParts";
import Submit from "../submit";
import "../../../styles.css";

class DraughtBeerWastage extends Component {
  state = {
    items: [],
    wastage: [],
    rid: [],
  ...
  cancelCourse = () => {
    document.getElementById("dbwast").reset();
  };
  calcTime = offset => {
    let d = new Date();
...
export default DraughtBeerWastage;
