...
import { Items, Wastage, UpdateWastage } from "./AperitifsParts";
import Submit from "../submit";
import "../../../styles.css";

class AperitifsWastage extends Component {
  state = {
    items: [],
    wastage: [],
    rid: [],
  ...
  cancelCourse = () => {
    document.getElementById("apwast").reset();
  };
  calcTime = offset => {
    let d = new Date();
...
export default AperitifsWastage;
