...
import { Items, Wastage, UpdateWastage } from "./RedWineParts";
import Submit from "../submit";
import "../../../styles.css";

class RedWineWastage extends Component {
  state = {
    items: [],
    wastage: [],
    rid: [],
  ...
  cancelCourse = () => {
    document.getElementById("rwwast").reset();
  };
  calcTime = offset => {
    let d = new Date();
