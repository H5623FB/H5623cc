...
import { Items, Wastage, UpdateWastage } from "./RoseWineParts";
import Submit from "../submit";
import "../../../styles.css";

class RoseWineWastage extends Component {
  state = {
    items: [],
    wastage: [],
    rid: [],
    ...
    wastageRef.on("value", snapshot => {
      ...
      if (wastageqty !== null) {
        ...
        let nullWastageRef = fire
          .database()
          .ref("ILEC/Pub/ClosingForm/Rose Wine/Wastage/00-00-00");
...
export default RoseWineWastage;
