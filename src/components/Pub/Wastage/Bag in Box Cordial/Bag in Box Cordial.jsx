...
import { Items, Wastage, UpdateWastage } from "./Bag in Box CordialParts";
import Submit from "../submit";
import "../../../styles.css";

class BAGinBoxCordialWastage extends Component {
  state = {
    items: [],
    wastage: [],
    rid: [],
  ...
  cancelCourse = () => {
    document.getElementById("bcwast").reset();
  };
  calcTime = offset => {
    let d = new Date();
...
export default BAGinBoxCordialWastage;
