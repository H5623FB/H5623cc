...
import { Items, Wastage, UpdateWastage } from "./BottleWaterParts";
import Submit from "../submit";
import "../../../styles.css";

class BottleWaterWastage extends Component {
  state = {
    items: [],
    wastage: [],
    rid: [],
  ...
  cancelCourse = () => {
    document.getElementById("bwwast").reset();
  };
  calcTime = offset => {
    let d = new Date();
...
export default BottleWaterWastage;
